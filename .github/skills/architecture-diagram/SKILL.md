...
- Examine build files (Java: pom.xml, build.gradle; .NET: *.csproj, *.sln)
- Review configuration files (application.properties, appsettings.json, database/API configs)
...
- **Unsupported project type**: Output a single line: `> ERROR: Unsupported project type. This skill supports Java and .NET projects only.`
